      ...
      <div id="search-bar">
        ...
        <div class="location-option-container">
          ...
          <b-form-select class="mr-2" v-model="selectSido">
            ...
            <b-form-select-option v-for="sido in sidoList" :key="sido.sidoCode" :value="sido.sidoCode">
              {{ sido.name }}
            </b-form-select-option>
          </b-form-select>
          <b-form-select class="mr-2" v-model="selectSigungu">
            <b-form-select-option :value="null" selected :disabled="true">시군구 검색</b-form-select-option>
            <b-form-select-option v-for="(sigungu, index) in sigunguList" :key="index" :value="sigungu.sigunguCode">
              {{ sigungu.name }}
            </b-form-select-option>
          </b-form-select>
          <b-form-select class="mr-2" v-model="selectDong">
            <b-form-select-option :value="null" selected :disabled="true">동 검색</b-form-select-option>
            <b-form-select-option v-for="(dong, index) in dongList" :key="index" :value="dong.dongCode">
              {{ dong.name }}
            </b-form-select-option>
          </b-form-select>
        ...
        <!-- 상세 검색 -->
        <ApartmentItemOptionDateVue optionName="날짜" :isOpen="isOpen[0]" @toggleOptionWindow="changeWindow(0)" />
        <ApartmentItemOption optionName="가격대" :isOpen="isOpen[1]" @toggleOptionWindow="changeWindow(1)" />
        <ApartmentItemOption optionName="면적" :isOpen="isOpen[2]" @toggleOptionWindow="changeWindow(2)" />
        <ApartmentItemOption optionName="층수" :isOpen="isOpen[3]" @toggleOptionWindow="changeWindow(3)" />
        <!-- 상세 검색 -->
      </div>
      <!-- 상세 검색 Container -->
      <!-- 카카오 지도 -->
